  ...
  return (
    <div className="bg-gray-50 min-h-screen py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeUp} className="bg-white p-8 rounded-lg shadow-xl">
          ...
          <motion.div variants={fadeUp} className="flex flex-col justify-center space-y-12 bg-gray-900 text-white p-12 rounded-lg shadow-xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <motion.h3 variants={fadeUp} className="text-2xl font-bold mb-8 text-yellow-500">Contact Information</motion.h3>

               <motion.div variants={fadeUp} className="flex items-start mb-8">
